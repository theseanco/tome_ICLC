...
while True:
    ...
    oscmsg = OSC.OSCMessage()
    oscmsg.setAddress("/x")
    oscmsg.append(int(result[1])+16000)
    c.send(oscmsg)

    oscmsg = OSC.OSCMessage()
    oscmsg.setAddress("/y")
    oscmsg.append(int(result[2])+16000)
    c.send(oscmsg)

    oscmsg = OSC.OSCMessage()
    oscmsg.setAddress("/z")
    oscmsg.append(int(result[3])+16000)
    c.send(oscmsg)

    oscmsg = OSC.OSCMessage()
    oscmsg.setAddress("/x1")
    oscmsg.append(int(result[4])+16000)
    c.send(oscmsg)

    oscmsg = OSC.OSCMessage()
    oscmsg.setAddress("/y1")
    oscmsg.append(int(result[5])+16000)
    c.send(oscmsg)
